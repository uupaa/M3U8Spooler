...
function M3U8Segment(playlist,  // @arg MediaPlaylistObject - { url, type, version, allowCache, mediaSequence, mediaSegments, targetDuration, totalDurations }
                     options) { // @arg Object - { spoolThreshold, spoolCallback, errorCallback, m3u8Callback, tsCallback, endCallback }
                                // @options.spoolThreshold UINT32 = 0 - msec
                                // @options.spoolCallback Function = null - spoolCallback(cachedDurations:UINT32):void
                                // @options.errorCallback Function = null - errorCallback(error:DetailError):void
                                // @options.m3u8Callback  Function = null - m3u8Callback(m3u8URL:URLString, m3u8:String, mediaPlaylist:MediaPlaylistObject, master:Boolean):void
...
M3U8Segment["prototype"] = Object.create(M3U8Segment, {
    ...
    "state":            { "get": M3U8Segment_get_state  }, // #state:Object - { state:String, totalDurations:UINT32, cachedDurations:UINT32, connections:UINT8 }
    "stopped":          { "get": function() { return this._stopped;         }},
    "totalDurations":   { "get": function() { return this._totalDurations;  }},
    "cachedDurations":  { "get": function() { return this._cachedDurations; }},
});
...
function M3U8Segment_get_state() { // @ret Object - { state:String, totalDurations:UINT32, cachedDurations:UINT32, connections:UINT8 }
    return {
        "state":            _toStateString.call(this),
