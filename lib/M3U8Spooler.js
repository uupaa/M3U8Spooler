...
//}@dev
    ...
    this._options["updateCallback"] = this._options["updateCallback"] || function(cachedDurations, updateType) {
        console.info("M3U8Spooler::updateCallback", cachedDurations, updateType);
    };
