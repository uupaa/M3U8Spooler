...
// --- class / interfaces ----------------------------------
function M3U8Spooler(options) { // @arg Object = null - { autoStart, updateCallback, errorCallback, m3u8Callback, tsCallback, endCallback, videoCanPlay, audioCanPlay, m3u8FetchIntervalRatio }
                                // @options.autoStart      Boolean = true
                                // @options.updateCallback Function = null - updateCallback(cachedDurations:UINT32):void
...
//}@dev
    ...
    this._options["updateCallback"] = this._options["updateCallback"] || function(cachedDurations) {
        console.info("M3U8Spooler::updateCallback", cachedDurations);
    };
...
//}@dev
    ...
    }, that._options["errorCallback"], function(masterStreams) {
        return _selectBetterStreamIndex.call(that, masterStreams);
    }, { "timeout": 2000 });
}
