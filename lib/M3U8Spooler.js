...
// --- class / interfaces ----------------------------------
function M3U8Spooler(options) { // @arg Object = null - { autoStart, spoolThreshold, spoolCallback, errorCallback, m3u8Callback, tsCallback, endCallback, videoCanPlay, audioCanPlay }
...
//}@dev
    ...
    this._options["errorCallback"] = this._options["errorCallback"] || function(error, url, code) {
        console.error("M3U8Spooler::errorCallback", error["message"], error["detail"]["url"], error["detail"]["code"]);
    };
...
M3U8Spooler["prototype"] = Object.create(M3U8Spooler, {
    ...
    "state":            { "get": M3U8Spooler_get_state }, // #state:Object|null - { state:String, totalDurations:UINT32, cachedDurations:UINT32, connections:UINT8 }
    "live":             { "get": function()    { return this._mediaPlaylist["type"] === "LIVE"; }},
    "src":              { "get": function()    { return this._m3u8URL; },
                          "set": function(url) { this._m3u8URL = url;  }},
    "stopped":          { "get": M3U8Spooler_get_stopped         },
    "totalDurations":   { "get": M3U8Spooler_get_totalDurations  },
    "cachedDurations":  { "get": M3U8Spooler_get_cachedDurations },
});
